...
func uploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Error("Error reading request body", slog.String(logging.KeyError, err.Error()))
	...
	if err != nil {
		slog.Error("Error parsing puppet report", slog.String(logging.KeyError, err.Error()))
	...
	if errors.Is(err, dataaccess.ErrDuplicate) {
		slog.Error("Duplicate run", slog.String(logging.KeyError, err.Error()))
